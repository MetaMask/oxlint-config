...
- chore: align Jest config with Jest ESLint config ([#8](https://github.com/MetaMask/oxlint-config/pull/8))
...
[Unreleased]: https://github.com/MetaMask/oxlint-config/compare/@metamask/oxlint-config-jest@0.1.0...HEAD
